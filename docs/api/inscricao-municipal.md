...
description: Web Service para consultar dados de Inscrições Municipais na Prefeitura de São Paulo (SP)
keywords: API, Webservice, Web Service, REST, JSON, IM, Inscrição Municipal, Consulta, API, Brasil
---
