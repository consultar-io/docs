---
title: API CRBM
description: Web Service para consultar dados de profissionais e estabelecimentos no Conselho Regional de Biomedicina (CRBM)
keywords: API, Webservice, Web Service, REST, JSON, CRBM, Profissional, Estabelecimento, Consulta, API, Brasil
---
...
Consulte os Termos de Uso em: [Termos de Uso](https://consultar.io/termos/?utm_source=docs&utm_medium=referral&utm_campaign=crbm)