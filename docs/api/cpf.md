...
keywords: API, Web Service, REST, JSON, CPF, Pessoa Física, Consulta, API, Brasil, Data de Nascimento, Validar Data de Nascimento, Validar Idade, Validar CPF, Consultar Data de Nascimento, Idade, Lei 15.211/2025, ECA Digital, Lei Felca
---
