...
| Versão                                                                     | Alterações                                                                                                          |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| [Versão 1](../endpoints-depreciados/v1/inscricao-estadual.md) (Depreciada) | Versão inicial                                                                                                      |
| [Versão 2](./inscricao-estadual.md) (Atual)                                | Alteração para suportar resposta para CNPJ e CPF com multiplas inscrições na mesma UF. Agora o retorno é uma lista. |
