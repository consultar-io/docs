---
title: API Latitude/Longitude - Geocodificação
description: Web Service para consultar a latitude e longitude de um endereço
keywords: API, Web Service, REST, JSON, Latitude, Longitude, Geocodificação, Geocode, Geocoding, Endereço, Consulta, API, Brasil
---

# API Latitude/Longitude - Geocodificação
...
## API Consultar Latitude/Longitude
